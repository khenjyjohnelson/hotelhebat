...
class C_tabel4 extends Omnitags
{
	...
	public function admin()
	{
		...
		$data1 = array(
			'title' => $this->v3_title['tabel4_alias'],
			'konten' => $this->v3['tabel4'],
			'dekor' => $this->tl12->dekor('tabel4')->result(),
	...
	public function tambah()
	{
		...
		$param2 = $this->v_post['tabel4_field2'];
		...
		if ($method2->num_rows() < 1) {
			...
			$data = array(
				$this->aliases['tabel4_field1'] => $this->v_post['tabel4_field1'],
				$this->aliases['tabel4_field2'] => $param2,
				$this->aliases['tabel4_field3'] => $this->v_post['tabel4_field3'],
				$this->aliases['tabel4_field4'] => $this->v_post['tabel4_field4'],
				$this->aliases['tabel4_field6'] => $this->v_post['tabel4_field6'],
			...
			if ($this->session->userdata($this->aliases['tabel4_field3'])) {
				...
				redirect(site_url('c_tabel4/admin'));
			} else {

				redirect(site_url('c_tabel4/login'));
			}
			...
			// $this->session->set_flashdata($this->views['flash1'], 'Konfirmasi ' . $this->aliases['tabel4_field4'] . ' salah!');
			...
			$this->session->set_flashdata($this->views['flash1'], $this->aliases['tabel4_field2'] . 'telah digunakan!');
			redirect($_SERVER['HTTP_REFERER']);
		}
	}
	...
	public function update()
	{
		...
		$tabel4_field1 = $this->v_post['tabel4_field1'];

		$data = array(
			$this->aliases['tabel4_field1'] => $this->v_post['tabel4_field1'],
			$this->aliases['tabel4_field2'] => $this->v_post['tabel4_field2'],
			$this->aliases['tabel4_field3'] => $this->v_post['tabel4_field3'],
			$this->aliases['tabel4_field4'] => $this->v_post['tabel4_field5'],
			$this->aliases['tabel4_field6'] => $this->v_post['tabel4_field6'],
		);
		...
		if ($update) {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_1['tabel4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		} else {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_2['tabel4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		}
	...
	public function hapus($tabel4_field1 = null)
	{
		...
		if ($hapus) {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_3['tabel4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		} else {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_4['tabel4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		}
	...
	public function laporan()
	{
		...
		$data1 = array(
			'title' => $this->v4_title['tabel4_alias'],
			'dekor' => $this->tl12->dekor('tabel4')->result(),
			'tbl4' => $this->tl4->ambildata()->result()
		);
	...
	public function profil()
	{
		...
		$data1 = array(
			'title' => $this->v6_title['tabel4_alias2'],
			'konten' => $this->v6['tabel4'],
			'dekor' => $this->tl12->dekor('tabel4')->result(),
	...
	public function login()
	{
		...
		$data1 = array(
			'title' => $this->views['tabel4_v2_title'],
			'dekor' => $this->tl12->dekor('tabel4')->result(),
		);
		...
		if ($cek_id->num_rows() > 0) {
			...
			if (password_verify($old_tabel4_field4, $cek_tabel4_field4)) {
				...
				if ($this->input->post('konfirm') === $this->v_post['tabel4_field4']) {
					...
					$this->session->set_flashdata($this->flash['tabel4_field4'], $this->flash_msg3_alt2['tabel4_field4_alias']);
					$this->session->set_flashdata('modal', $this->flash_func['tabel4_field4']);
					redirect($_SERVER['HTTP_REFERER']);
				}
				...
				$this->session->set_flashdata($this->flash['tabel4_field4'], $this->flash_msg3_alt1['tabel4_field4_alias']);
				$this->session->set_flashdata('modal', $this->flash_func['tabel4_field4']);
				redirect($_SERVER['HTTP_REFERER']);
			}
			...
			$this->session->set_flashdata($this->flash['tabel4_field4'], $this->flash_msg5['tabel4_alias2']);
			$this->session->set_flashdata('modal', $this->flash_func['tabel4_field4']);
			redirect($_SERVER['HTTP_REFERER']);
		}
	}
	...
	public function ceklogin()
	{
		...
		if ($method1->num_rows() > 0) {
			...
			if (password_verify($param8, $method8)) {
				...
				$this->session->set_flashdata($this->views['flash1'], $this->aliases['tabel4_field4_alias'] . ' salah!');
				redirect(site_url('c_tabel4/login'));
			}
			...
			$this->session->set_flashdata($this->views['flash1'], $this->aliases['tabel4_field1_alias'] . ' tidak tersedia!');
			redirect(site_url('c_tabel4/login'));
		}
