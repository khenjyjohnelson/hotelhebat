...
class C_tabel_e4 extends Omnitags
{
	...
	public function index()
	{
		...
		$data1 = array(
			...
			'dekor' => $this->tl_b1->dekor('tabel_e4')->result(),
	...
	public function tambah()
	{
		...
		$simpan = $this->tl_e4->simpan($data);
		// $simpan = $this->tl_e4->simpan($query);

		if ($simpan) {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_1['tabel_e4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		} else {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_2['tabel_e4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		}
	...
	public function update()
	{
		...
		$update = $this->tl_e4->update($data, $tabel_e4_field1);

		if ($update) {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_3['tabel_e4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		} else {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_4['tabel_e4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		}
	...
	public function hapus($tabel_e4_field1 = null)
	{
		...
		$hapus = $this->tl_e4->hapus($tabel_e4_field1);

		if ($hapus) {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_5['tabel_e4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		} else {
			$this->session->set_flashdata($this->views['flash1'], $this->flash1_msg_6['tabel_e4_alias']);
			$this->session->set_flashdata('toast', $this->views['flash1_func1']);
		}
