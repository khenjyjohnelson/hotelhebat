...
<a class="btn btn-info mb-4" href="<?= site_url('c_tabel1/laporan') ?>" target="_blank">
...
<div id="tambah" class="modal fade tambah">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= site_url('c_tabel1/tambah') ?>" method="post">
  ...
  <div id="ubah<?= $tl1->$tabel1_field1; ?>" class="modal fade ubah">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?= site_url('c_tabel1/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <div class="form-group">
              <label><?= $tabel1_field2_alias ?></label>
