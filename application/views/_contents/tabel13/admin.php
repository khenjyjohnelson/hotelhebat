...
<a class="btn btn-info mb-4" href="<?= site_url('c_tabel13/laporan') ?>" target="_blank">
        ...
        <tr>
          ...
          <td><a class="btn btn-light text-info" type="button" data-toggle="modal"
            ...
            <a class="btn btn-light text-danger" onclick="return confirm('Hapus data <?= $tabel13 ?>?')"
              href="<?= site_url('c_tabel13/hapus/' . $tl13->$tabel13_field1) ?>">
...
<div id="tambah" class="modal fade tambah">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= site_url('c_tabel13/tambah') ?>" enctype="multipart/form-data" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea id="editor1" class="form-control" name="<?= $tabel13_field5_input ?>" placeholder="Masukkan <?= $tabel13_field5_alias ?>" required cols="30" rows="10"></textarea>
          </div>
  ...
  <div id="ubah<?= $tl13->$tabel13_field1; ?>" class="modal fade ubah">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?= site_url('c_tabel13/update') ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
